...
## 4. [VocalRender: Score-Native Singing Voice Synthesis for Real-World Composition](https://arxiv.org/abs/2607.27768v1)
...
## 5. [Teffic-Audio: Tell Fact from Fiction](https://arxiv.org/abs/2607.28351v1)
...
## 6. [Correlation between prosody and pragmatics: A case study of the discourse marker hālā `now' in Persian](https://arxiv.org/abs/2607.28359v1)
...
## 7. [Integrating Contextual Embeddings into Evaluation of Expressive MIDI Piano Performances](https://arxiv.org/abs/2607.27909v1)
...
## 8. [Face and Voice Cross-modal Association with Learning Convex Feature Embedding](https://arxiv.org/abs/2607.28129v1)
...
---
## 9. [AgenticASR: Refining Speech Recognition in Real-World Scenarios via an Agentic Approach](https://arxiv.org/abs/2607.28175v1)

**Authors:** Zixuan Jiang, Binghao Qiang, Jiaying Chi, Yanqiao Zhu, Kai Yu et al.

**Categories:** `cs.AI`
  | 15 pages, 3 figures, 14 tables
**Score: 4.47/10** (Obj:5 Id:5 Ind:5 Comp:2 Eff:5 Nov:2 Rep:5)
