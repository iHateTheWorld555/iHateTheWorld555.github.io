...
---
## 3. [CLASVS: Continuous-Latent Autoregression for Melody-Preserving Lyric Editing in Singing Voice Synthesis](https://arxiv.org/abs/2608.03253v1)
...
## 4. [Multi-Task Multi-Frame Visual Piano Transcription](https://arxiv.org/abs/2608.03419v1)
...
## 5. [On the Geometry of Music Bandwidth Extension in Latent Spaces of Audio Codecs](https://arxiv.org/abs/2608.03721v1)
...
## 6. [GROW: Group-Relative Advantage-Weighted On-Policy Reinforcement Learning of Autoregressive-Diffusion Text-to-Speech model](https://arxiv.org/abs/2608.03215v1)
...
## 7. [Hear to See: Discerning Stateful Listening for Audio-Visual Instance Segmentation](https://arxiv.org/abs/2608.03264v1)
...
## 8. [Echo-Aware Modulation for Compact-Latent Frequency-Time Modeling in Lightweight Acoustic Echo Cancellation](https://arxiv.org/abs/2608.03650v1)
...
## 9. [Towards Real-world Environment-aware Zero-shot Text-to-speech Synthesis via Disentangled Audio Infilling](https://arxiv.org/abs/2608.03011v1)
...
## 10. [Towards More Expressive Spoken LLMs: Fine-Grained Intent Benchmarking and Acoustic-Lexical Decoupled Policy Optimization](https://arxiv.org/abs/2608.03054v1)
...
## 11. [Transfer Learning for Avian Bioacoustics under Sparse Positive Labels](https://arxiv.org/abs/2608.03977v1)
...
## 12. [Language-Specialized Multi-Teacher On-Policy Distillation for Multilingual LLM-Based ASR](https://arxiv.org/abs/2608.03610v1)
...
## 13. [Identity-Faithful Audio-Visual Target Speaker Extraction with QIANGDA and VOXBLINK2-AVSE](https://arxiv.org/abs/2608.03964v1)
...
## 14. [Learning Music Style for Piano Arrangement Through Cross-Modal Bootstrapping](https://arxiv.org/abs/2608.03050v1)
...
## 15. [DDSynth-RL: Audio Synthesizer Inversion via Discrete Diffusion with Reinforcement Learning](https://arxiv.org/abs/2608.03032v1)
...
## 16. [MeloCodec: Harnessing Melodic Priors for High-Fidelity Singing Voice Representation](https://arxiv.org/abs/2608.03021v1)
...
## 17. [Cross-cultural evaluation of taste-sound correspondences in AI-generated music](https://arxiv.org/abs/2608.03433v1)
...
## 18. [Speaker Verification Under Real Classroom Conditions for English Speech](https://arxiv.org/abs/2608.03623v1)
...
## 19. [AI-Based Sound Effect Generation: A Narrative Review of Generative Models Across Input Modalities](https://arxiv.org/abs/2608.03742v1)
...
## 20. [Calliphony: A Calligraphy-Driven Interface for Real-Time Generative Music Performance](https://arxiv.org/abs/2608.03040v1)
...
## 21. [Equivariant Music Transformer](https://arxiv.org/abs/2608.03920v1)
