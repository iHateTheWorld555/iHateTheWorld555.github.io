...
## 8. [VAD to the Bone: Ultra-Tiny Speech Activity Detection for Edge Deployment](https://arxiv.org/abs/2607.25870v1)
...
**Score: 5.84/10** (Obj:8 Id:5 Ind:8 Comp:6 Eff:5 Nov:5 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-28/2607.25870v1/)
...
## 9. [Spacing Out: On the Reliability of Binaural Music Source Separation Metrics](https://arxiv.org/abs/2607.25919v1)
...
## 10. [Depression Markers in Speech: An Approach based on Tract Variables Dynamics](https://arxiv.org/abs/2607.25888v1)
...
## 11. [AMRD: Adaptive Multi-Teacher Relational Distillation for Lightweight Speech Emotion Recognition](https://arxiv.org/abs/2607.25289v1)

**Authors:** Yuqi Li, Yi-Cheng Lin, Xianglong Wang, Kuo Yang, Xiaoqin Feng et al.

**Categories:** `cs.LG`
**Score: 5.60/10** (Obj:8 Id:5 Ind:9 Comp:5 Eff:5 Nov:4 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-28/2607.25289v1/)
...
---
## 12. [Evaluation of forced alignment of code-mixed speech: the case of Hindi-English](https://arxiv.org/abs/2607.25581v1)
...
## 13. [LLM4OSC: Profile-Bound Natural Language Control with Deterministic Validation for Open Sound Control](https://arxiv.org/abs/2607.26024v1)
...
## 14. [Device Invariance using Domain Adaptation on Acoustic Scene Classification](https://arxiv.org/abs/2607.25887v1)
...
## 15. [A Cross-lingual Comparison of Human and Classification Model Entrainment Behavior in Code-switched Speech Settings](https://arxiv.org/abs/2607.25202v1)
...
## 16. [SpeechLLM Meets Federated Learning for End-to-End ASR: English and Italian Case Studies](https://arxiv.org/abs/2607.25716v1)
...
**Score: 4.80/10** (Obj:6 Id:5 Ind:8 Comp:3 Eff:5 Nov:3 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-28/2607.25716v1/)
