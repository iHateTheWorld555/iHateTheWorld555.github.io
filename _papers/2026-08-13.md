...
## 1. [Reasoning for Social Audio-Visual Question Answering: Where Do We Stand?](https://arxiv.org/abs/2608.13239v1)
...
**Score: 7.10/10** (Obj:8 Id:8 Ind:6 Comp:9 Eff:8 Nov:6 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-08-13/2608.13239v1/)
...
---
## 2. [Alignment Drift in Single-Model Speculative Decoding for ASR: Mechanism, Correction, and Cost](https://arxiv.org/abs/2608.12703v1)
...
## 3. [CASA: Content-Acoustic Speaking Assessment with Speech Encoder and Large Language Model](https://arxiv.org/abs/2608.13101v1)
...
## 4. [VoxAudio: Vocalized Audio Synthesis via Multi-Reward Autoregressive Flow Matching](https://arxiv.org/abs/2608.12951v1)
...
**Score: 5.40/10** (Obj:6 Id:5 Ind:6 Comp:5 Eff:5 Nov:6 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-08-13/2608.12715v1/)
...
## 6. [FastThaiG2P: Lightning-fast Thai Grapheme-to-phoneme Conversion for Voice Agent Pipelines](https://arxiv.org/abs/2608.12814v1)
