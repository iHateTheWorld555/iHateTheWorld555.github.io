...
**Categories:** `eess.AS`
**Score: 6.30/10** (Obj:8 Id:5 Ind:8 Comp:6 Eff:5 Nov:7 Rep:6)
- **Strength:** 中 — MUBF 机制有真实新颖性，DUHV 是标准技术应用。整体复杂度较高，改进幅度中等。
- **Weakness:** 补充与 AD-AVSR、Router-Gated AVSR、Omni-AVSR 等近期 AVSR 工作在 LRS2 上的比较，这些工作发表早于本文，不属 concurrent work。
...
## 4. [MADB: A Large-Scale Music Aesthetics Dataset with Professional and Multi-Dimensional Annotations](https://arxiv.org/abs/2607.06929v1)
...
## 5. [A Reliability Assessment of LALM Audio Judges for Full-Duplex Voice Agents](https://arxiv.org/abs/2607.07985v1)
...
## 6. [MMGenre: Benchmarking Singing Voice Synthesis across Multiple Musical Genres](https://arxiv.org/abs/2607.06986v1)
...
---
## 8. [Multimodal Unlearning Across Vision, Language, Video, and Audio: Survey of Methods, Datasets, and Benchmarks](https://arxiv.org/abs/2607.07907v1)
