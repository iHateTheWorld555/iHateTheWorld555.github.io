...
---
## 8. [COALA: Robust Contextualized Speech-augmented Language Modeling for ASR via Contrastive Regularizer and Biasing Score Estimation](https://arxiv.org/abs/2607.08117v1)
...
**Categories:** `cs.SD`
**Score: 5.80/10** (Obj:8 Id:6 Ind:8 Comp:5 Eff:6 Nov:5 Rep:6)
