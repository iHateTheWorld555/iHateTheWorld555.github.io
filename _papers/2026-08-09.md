...
## 2. [A Unifying Perspective on Audio Generative Modeling: Latent Representations and Modeling Strategies](https://arxiv.org/abs/2608.08667v1)

**Authors:** Dongchao Yang

**Categories:** `eess.AS`
**Score: 6.84/10** (Obj:8 Id:5 Ind:8 Comp:8 Eff:5 Nov:6 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-08-09/2608.08667v1/)
...
## 3. [VoxZip: Semantic-Anchored Temporal KV Cache Compression for Long-Context Audio Inference](https://arxiv.org/abs/2608.08569v1)
...
## 4. [AeroReformer2: Spoken-Query Referring Segmentation for Aerial Images](https://arxiv.org/abs/2608.08874v1)

**Authors:** Rui Li, Chenxi Duan, Haoyang Yang

**Categories:** `cs.CV`
**Score: 6.50/10** (Obj:9 Id:6 Ind:5 Comp:5 Eff:8 Nov:6 Rep:9)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-08-09/2608.08874v1/)
...
## 5. [Beyond Reconstruction: Full-Context Generative DiT for Music Generation](https://arxiv.org/abs/2608.08787v1)
...
## 6. [Visual Token Codec: Unleashing Spatial Redundancy for ViT Feature Coding](https://arxiv.org/abs/2608.08832v1)
...
---
## 7. [Deferred Audio Pruning with Local Audio-Visual Dynamics for Omni-LLMs](https://arxiv.org/abs/2608.08794v1)
...
## 8. [Multilingual Emotion Neurons in Large Audio-Language Models](https://arxiv.org/abs/2608.08772v1)
...
## 9. [From Speech to Interaction: Analyzing Multimodal Systems in Cocktail-Party Scenarios](https://arxiv.org/abs/2608.08510v1)

**Authors:** Thai-Binh Nguyen, Zhaolin Li, Jan Niehues, Alexander Waibel

**Categories:** `cs.CL`
  | Accepted at ICMI 2026
**Score: 6.10/10** (Obj:8 Id:5 Ind:8 Comp:6 Eff:6 Nov:5 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-08-09/2608.08510v1/)
...
## 10. [BAMU: Bitstream-Aware Marginal-Utility Allocation for Frozen Pretrained Neural Speech Codecs](https://arxiv.org/abs/2608.08432v1)
...
## 11. [CuteTTS: Efficient and High-Quality Speech Synthesis via Autoregressive Modeling of Continuous Latents](https://arxiv.org/abs/2608.08638v1)
...
## 12. [Towards an LLM-based method for quantifying the sexual content in song lyrics](https://arxiv.org/abs/2608.08885v1)
...
## 13. [Physics-Informed Learning for Robust Acoustic Localization with Calibrated Uncertainty](https://arxiv.org/abs/2608.08911v1)
