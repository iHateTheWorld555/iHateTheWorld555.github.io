...
**Score: 6.42/10** (Obj:8 Id:5 Ind:5 Comp:6 Eff:6 Nov:6 Rep:8)
- **Strength:** 中 — 系统设计干净、组件选择合理、cue ablation 到位、零样本可用；但同期 NL-prompt EVC baseline 缺位，无法把方法贡献与 backbone 贡献完全分离。
- **Weakness:** 关键变量隔离不充分。
