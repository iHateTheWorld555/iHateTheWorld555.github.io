...
---
## 2. [TRACE-EVC: Text-Guided Relative Affective Control for Zero-Shot Emotional Voice Conversion](https://arxiv.org/abs/2607.03666v1)
...
## 3. [TokAN: Accent Normalization Using Self-Supervised Speech Tokens](https://arxiv.org/abs/2607.03928v1)
...
## 4. [Probing Low-Level Acoustic Attribute Encoding in CLAP Audio Embeddings](https://arxiv.org/abs/2607.03806v1)
...
**Score: 5.79/10** (Obj:8 Id:6 Ind:8 Comp:6 Eff:6 Nov:5 Rep:5)
