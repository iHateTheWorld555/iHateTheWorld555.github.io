...
---
## 6. [Toward Interpretable Speech Deepfake Detection using Artifact-Specific Experts and Calibrated Detection Scores](https://arxiv.org/abs/2607.21127v1)

**Authors:** Viola Negroni, Xin Wang, Wanying Ge, Paolo Bestagini, Junichi Yamagishi et al.

**Categories:** `cs.SD`
  | In peer review
**Score: 5.05/10** (Obj:8 Id:4 Ind:7 Comp:6 Eff:3 Nov:5 Rep:5)
...
## 7. [From Read Speech to Spoken Digits: A Task-Specific Evaluation of Speech Privacy With Informed Attackers](https://arxiv.org/abs/2607.21393v1)
