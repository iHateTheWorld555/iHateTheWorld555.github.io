...
**Score: 7.74/10** (Obj:8 Id:8 Ind:6 Comp:8 Eff:8 Nov:7 Rep:9)
- **Strength:** 中 — 组件（frozen backbone + MLP + supervised contrastive + instance discrimination）均为已有，方法层面无新机制；价值在 reframing 与受控变量设计。
- **Weakness:** 三个独立性问题，按严重度排：(a) Major 但已处理——UCS corpus 的 10,420 clip 由 zero-shot CLAP top-5 验证保留（13,579→10,420，77%），而 CLAP 同时是主报告 encoder。这是数据筛选与主评测同源。
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04337v1/)
...
**Score: 7.16/10** (Obj:8 Id:8 Ind:6 Comp:8 Eff:8 Nov:6 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04140v1/)
...
**Score: 7.05/10** (Obj:8 Id:6 Ind:8 Comp:8 Eff:8 Nov:6 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04498v1/)
...
## 4. [Weakly Guided and Autoregressive Beamformer Parameterization for Generalizable Moving Speaker Extraction in Higher-Order Ambisonics](https://arxiv.org/abs/2607.04471v1)
...
**Score: 6.16/10** (Obj:8 Id:5 Ind:8 Comp:5 Eff:5 Nov:4 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04471v1/)
...
## 5. [MOSAIC: Interpretable Multi-Token Cross-Attention of Biophonetic and Self-Supervised Representations for Unified Voice Anti-Spoofing](https://arxiv.org/abs/2607.04314v1)
...
**Score: 6.05/10** (Obj:8 Id:5 Ind:8 Comp:5 Eff:3 Nov:3 Rep:8)
- **Strength:** 低 — 五个公开 benchmark 全部输给已报告 baseline，"unified single model" 的差异化不足以支撑方法价值。
- **Weakness:** 表 I 主结果
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04314v1/)
...
## 6. [Speaker-Disentangled Chunk-Wise Regression for Syllabic Tokenization](https://arxiv.org/abs/2607.04064v1)
...
**Score: 6.00/10** (Obj:8 Id:6 Ind:8 Comp:5 Eff:6 Nov:4 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04064v1/)
...
## 7. [Training-Free Model Selection and Domain-Aware Score Calibration for First-Shot Anomalous Sound Detection](https://arxiv.org/abs/2607.04526v1)

**Authors:** Grach Mkrtchian

**Categories:** `cs.SD, cs.AI`
**Score: 5.79/10** (Obj:8 Id:6 Ind:8 Comp:6 Eff:5 Nov:5 Rep:9)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04526v1/)
...
## 8. [EVAS: Efficient Multimodal Temporal Forgery Localization via Audio-Visual Synergy and Steered Boundary Calibration](https://arxiv.org/abs/2607.04472v1)

**Authors:** Shen Shen, Quan Zhang, Dan Jiang, Ke Zhang

**Categories:** `cs.CV`
**Score: 4.95/10** (Obj:9 Id:5 Ind:8 Comp:4 Eff:6 Nov:3 Rep:3)
- **Strength:** 低 — 三个核心模块均为已有方法换名/拼装，novelty 弱，且 MAVS 的 ablation 在 mAP 上不增反降，因果识别不充分。
- **Weakness:** 三个“创新”均为已有方法的换名或拼装：(1) MAVS = 多层 cross-attention + 残差累加，与本领域 AVFusion、UMMAFormer 的 cross-modal attention 同源，本领域已有；(2) BAR = cascade multi-stage head + GT-guided mask 训练 + 推理只用 head 1，cascade + teacher-forcing 是检测领域标准（Cas。
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04472v1/)
...
---
## 9. [Noisy Environment Adaptation of Neural Speech Codec via Focal Mask and Noise Feature Separation](https://arxiv.org/abs/2607.04195v1)
...
**Score: 4.95/10** (Obj:5 Id:4 Ind:8 Comp:4 Eff:5 Nov:4 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04195v1/)
...
## 10. [Towards Digital Preservation of Efik: TTS for a Low-Resource African Language](https://arxiv.org/abs/2607.04515v1)
...
**Score: 4.42/10** (Obj:8 Id:2 Ind:5 Comp:3 Eff:5 Nov:4 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04515v1/)
...
**Score: 3.95/10** (Obj:6 Id:5 Ind:5 Comp:5 Eff:4 Nov:3 Rep:5)
- **Strength:** 低 — 三种估计器均教科书内容；最被推荐的 LogReg 在 K-Medoids 下过估、在 Uncertainty 下完全失效，"robust recovery" 叙事与实验结果矛盾。
- **Weakness:** 作者明确写 "To our knowledge, this is the first work in computer audition to explicitly employ importance weighting to correct selection bias for deployment evaluation"。
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04463v1/)
...
## 12. [Auto-AEG: Scalable Data Construction for Open-Vocabulary Audio Event Grounding](https://arxiv.org/abs/2607.04383v1)
...
**Categories:** `cs.SD, cs.AI`
  ...
  | Work in progress
**Score: 3.68/10** (Obj:5 Id:4 Ind:5 Comp:4 Eff:4 Nov:2 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04383v1/)
...
**Categories:** `cs.SD, cs.AI`
  ...
  | 8 pages, 4 figures
**Score: 3.26/10** (Obj:5 Id:2 Ind:3 Comp:4 Eff:2 Nov:5 Rep:2)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-05/2607.04154v1/)
