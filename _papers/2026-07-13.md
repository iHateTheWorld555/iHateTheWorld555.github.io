...
## 5. [Tight-Frame Reconstruction for Acoustic Intensity Estimation Using Cardioid Microphone Pairs](https://arxiv.org/abs/2607.11059v1)

**Authors:** Akira Omoto

**Categories:** `eess.AS`
  | Submitted to Acoustical Science and Technology
**Score: 6.30/10** (Obj:8 Id:6 Ind:8 Comp:8 Eff:5 Nov:6 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-13/2607.11059v1/)
...
## 6. [Teaching Speech Enhancement Models to Sing: Domain Adaptation from Speech Enhancement to Singing Voice Separation](https://arxiv.org/abs/2607.11630v1)
...
## 7. [The SonicAGI System for the REAL-TSE Challenge](https://arxiv.org/abs/2607.11083v1)

**Authors:** Kai Li, Wendi Sang, Jintao Cheng, Xiaolin Hu

**Categories:** `cs.SD`
**Score: 6.16/10** (Obj:9 Id:5 Ind:6 Comp:5 Eff:8 Nov:5 Rep:5)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-13/2607.11083v1/)
...
## 8. [CHARM: Charge Calibration and Acoustic Rescue for LLM-based Multimodal Sarcasm Detection](https://arxiv.org/abs/2607.11102v1)
...
## 9. [Simple Features and Honest Calibration for Ambivalence and Hesitancy Recognition in Video](https://arxiv.org/abs/2607.11120v1)
...
## 10. [Qwen-Audio-VAE Technical Report](https://arxiv.org/abs/2607.11738v1)
...
## 11. [VoxENES 2026: Benchmarking Generalization of Speech Spoofing Detectors Against LLM-Era TTS and Voice Conversion](https://arxiv.org/abs/2607.11706v1)
...
## 12. [Anysynth:Zero-Shot Instrument Cloning via In-Context Learning and Asymmetric Hierarchical Guidance](https://arxiv.org/abs/2607.11143v1)
...
## 13. [Qwen-Music Technical Report](https://arxiv.org/abs/2607.11699v1)
...
## 14. [Evidence Subspace Projection: Measuring How Much Evidence Explains Deepfake Detection in Self-Supervised Speech Models](https://arxiv.org/abs/2607.11538v1)

**Authors:** Yixuan Xiao, Cheng-Wei Lin, Xin Wang, Yassine El Kheir, Arnab Das et al.

**Categories:** `cs.SD`
  | Accepted to Interspeech 2026
**Score: 5.20/10** (Obj:8 Id:5 Ind:5 Comp:8 Eff:5 Nov:5 Rep:8)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-13/2607.11538v1/)
...
## 15. [Unified Gradient Projection: Language-Balanced Continual Learning for Multilingual Low-Resource ASR](https://arxiv.org/abs/2607.11163v1)
...
## 16. [StoryTeller: Training-Free Narrative Grounding for Long-Form Audio Description](https://arxiv.org/abs/2607.11798v1)

**Authors:** Seung Hyun Hahm, Minh T. Dinh, SouYoung Jin

**Categories:** `cs.CV, cs.AI`
  | Accepted to the European Conference on Computer Vision (ECCV) 2026
**Score: 5.10/10** (Obj:8 Id:5 Ind:5 Comp:4 Eff:5 Nov:4 Rep:6)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-13/2607.11798v1/)
...
---
## 17. [MusicMark: A Robust Generative Watermarking Framework for Music Generation](https://arxiv.org/abs/2607.11117v1)
...
## 18. [Verifier-Guided Twelve-Tone Composition: A Generate-Verify-Repair Harness for Symbolic Music Generation](https://arxiv.org/abs/2607.11334v1)
...
## 19. [Semantic Sampling via Learnable Observation Front Ends](https://arxiv.org/abs/2607.11260v1)
...
## 20. [Beyond Benchmarks: Exposing the Hidden Crisis in Bangla Hate Speech Detection](https://arxiv.org/abs/2607.11597v1)
...
## 21. [Synchronized Three-Dimensional Vocal-Tract Motion for Speech Synchronization via Joint-Embedding Predictive Architecture Alignment](https://arxiv.org/abs/2607.11772v1)
...
## 22. [Casting Everything to Online API Services? A Survey of Integrating Localized Speech Recognition Models in Robotic Systems](https://arxiv.org/abs/2607.11792v1)
...
**Score: 2.63/10** (Obj:5 Id:2 Ind:4 Comp:2 Eff:2 Nov:2 Rep:3)
...
- **Full review:** [Claude Code 全文七公理审稿](/reviews/2026-07-13/2607.11792v1/)
